...
var grammar = {
    ...
    {"name": "Main$ebnf$1$subexpression$1", "symbols": ["Input"]},
    ...
    {"name": "DotBlock$subexpression$1$string$4", "symbols": [{"literal":"c"}, {"literal":"a"}, {"literal":"t"}, {"literal":"c"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "DotBlock$subexpression$1", "symbols": ["DotBlock$subexpression$1$string$4"]},
    ...
    {"name": "DotBlock$string$2", "symbols": [{"literal":"."}, {"literal":"u"}, {"literal":"n"}, {"literal":"t"}, {"literal":"i"}, {"literal":"l"}, {"literal":"("}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "DotBlock", "symbols": ["DotBlock$string$2", "_star", "BooleanLogic", "_star", {"literal":")"}]},
    ...
    {"name": "Input$macrocall$2", "symbols": ["Slug"]},
    {"name": "Input$macrocall$1", "symbols": [{"literal":"'"}, "Input$macrocall$2", {"literal":"'"}], "postprocess": quoted => quoted[1][0].join('')},
    {"name": "Input", "symbols": ["Input$string$1", "_", "Input$macrocall$1"]},
    {"name": "Tag$string$1", "symbols": [{"literal":"T"}, {"literal":"A"}, {"literal":"G"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Tag$macrocall$2", "symbols": ["Slug"]},
    {"name": "Tag$macrocall$1", "symbols": [{"literal":"'"}, "Tag$macrocall$2", {"literal":"'"}], "postprocess": quoted => quoted[1][0].join('')},
    {"name": "Tag", "symbols": ["Tag$string$1", "_", "Tag$macrocall$1"]},
    ...
    {"name": "BooleanLogic$string$1", "symbols": [{"literal":"="}, {"literal":"="}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "BooleanLogic", "symbols": ["Any", "_", "BooleanLogic$string$1", "_", "Any"]},
    ...
    {"name": "Slug$ebnf$1", "symbols": [/[a-zA-Z0-9-]/]},
    {"name": "Slug$ebnf$1", "symbols": ["Slug$ebnf$1", /[a-zA-Z0-9-]/], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "Slug", "symbols": ["Slug$ebnf$1"]},
    ...
    {"name": "Any", "symbols": ["StringTemplate"]},
    {"name": "Any", "symbols": ["Number"]},
    {"name": "Any", "symbols": ["Boolean"]},
    {"name": "Any", "symbols": ["Slug"]},
    ...
    {"name": "_star$ebnf$1", "symbols": []},
    {"name": "_star$ebnf$1", "symbols": ["_star$ebnf$1", {"literal":" "}], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "_star", "symbols": ["_star$ebnf$1"], "postprocess": () => null},
    {"name": "nl", "symbols": [/[\r\n]/], "postprocess": () => 'nl'},
